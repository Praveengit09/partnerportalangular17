...
export class PharmacyInvoiceComponent implements OnInit {

  @Input('inPatientInvoice') public inPatientInvoice: boolean;
  ...
  gotoPharmacyOrderList(): void {
    this.pharmacyAdviseTrack.billNoList && this.pharmacyAdviseTrack.billNoList.length > 0 ? this.router.navigate(['/app/pharmacy/inpatientorders/list']) : this.router.navigate(['/app/pharmacy/orders']);
  }
